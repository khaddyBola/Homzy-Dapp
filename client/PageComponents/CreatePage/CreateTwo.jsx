    ...
    if (file) {
      try {
        ...
        const response = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `8a0f2e31d3456e648ab5`,
            pinata_secret_api_key: `
            c5343f3e6124799b8aa8b53a81e466d679157e2ee6eb0971008292aa357f77cf`,
                    ...
                    <div class="nuron-information mb--30">
                      <div class="single-notice-setting">
                        ...
                        <div class="content-text">
                          <p>This platform is free for now   <strong>Promo week</strong></p>
                        </div>
                      </div>
                    </div>
                  </div>
