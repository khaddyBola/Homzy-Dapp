          ...
          <div class="col-lg-8">
            <div class="button-group isotop-filter filters-button-group d-flex justify-content-start justify-content-lg-end mt_md--30 mt_sm--30">
              ...
              <button data-filter=".cat--3">
                <span class="filter-text">Worshiphouse</span>
              </button>
          ...
          <div class="grid-metro5 mesonry-list">
            ...
            <div class="grid-metro-item cat--1 cat--3">
              <div class="product-style-one no-overlay with-placeBid">
                ...
                <div class="product-share-wrapper">
                  <div class="profile-share">
                    <a
                      href="#"
                      class="avatar"
                      data-tooltip="Owener:Tee-Blinks"
                    >
                ...
                <a href="#">
                  <span class="product-name">Preset</span>
                </a>
            ...
            <div class="grid-metro-item cat--5 cat--6">
              <div class="product-style-one no-overlay with-placeBid">
                ...
                <a href="#">
                  <span class="product-name">Matex</span>
                </a>
            ...
            <div class="grid-metro-item cat--1 cat--2">
              <div class="product-style-one no-overlay with-placeBid">
                ...
                <div class="product-share-wrapper">
                  <div class="profile-share">
                    <a
                      href="#"
                      class="avatar"
                      data-tooltip="Owener:Ms.Khadijah"
                    >
                      <img src="/client/client-2.png" alt="Nft_Profile" />
                    </a>
                    <a
                ...
                <a href="#">
                  <span class="product-name">Mummin</span>
                </a>
            ...
            <div class="grid-metro-item cat--1 cat--2">
              <div class="product-style-one no-overlay with-placeBid">
                ...
                <a href="#">
                  <span class="product-name">Khadijah</span>
                </a>
            ...
            <div class="grid-metro-item cat--1 cat--2">
              <div class="product-style-one no-overlay with-placeBid">
                ...
                <a href="#">
                  <span class="product-name">Ahmad</span>
                </a>
            ...
            <div class="grid-metro-item cat--5 cat--4">
              <div class="product-style-one no-overlay with-placeBid">
                ...
                <div class="product-share-wrapper">
                  <div class="profile-share">
                    ...
                    <a
                      href="#"
                      class="avatar"
                      data-tooltip="Owener:Mr.Abdullah"
                    >
                      <img src="/client/client-6.png" alt="Nft_Profile" />
                    </a>
                    <a
                ...
                <a href="#">
                  <span class="product-name">Matto</span>
                </a>
            ...
            <div class="grid-metro-item cat--5 cat--6">
              <div class="product-style-one no-overlay with-placeBid">
                ...
                <a href="#">
                  <span class="product-name">Lareal</span>
                </a>
